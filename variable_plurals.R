...
cat_con = matrix(c(
                   ...
                   sqrt(summary(lm(log_wf ~ register, data = s_dur_ambig))$r.squared),
                   ...
                   sqrt(summary(lm(log_wf ~ next_phon_class, data = s_dur_ambig))$r.squared),
                   ...
                   sqrt(summary(lm(log_wf ~ prev_mention, data = s_dur_ambig))$r.squared),
                   ...
                   sqrt(summary(lm(log_wf ~ syntax_f5_cat, data = s_dur_ambig))$r.squared),
                   ...
                   sqrt(summary(lm(log_wf ~ syntax_f6_cat, data = s_dur_ambig))$r.squared),
                   ...
                   sqrt(summary(lm(log_wf ~ syntax_f7_cat, data = s_dur_ambig))$r.squared),
                   ...
                   sqrt(summary(lm(log_wf ~ syntax_f8_cat, data = s_dur_ambig))$r.squared),
                   ...
                   sqrt(summary(lm(log_wf ~ stressed, data = s_dur_ambig))$r.squared),
...
plot(effect("rel_freq_pl:pl_prop", control_trim2, x.var = "pl_prop")
     , multiline=T, rug = F, main = "", ylab = "Residuals in log(seconds)"
     )
