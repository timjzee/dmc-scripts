...
def getFeatureLabel(frame_start, frame_end, feature, seg_index, segments, words, word_syllables, word_segments, comment_intervals):
    ...
    if seg_index == 0:
        return -1
    # feature-specific criteria; see /notes/2021/17jun.txt /notes/2021/29jun.txt
    if feature == "@":
        ...
        # negative
            ...
            if phon.strip("#") in ["n", "N", "m"] and phon[-1] == "#" and final_n:
                return -1
            else:
                if prev_phon_str not in vowels + ["w", "j", "r", "l"] and prev_phon[-1] != "#" and next_phon_str not in vowels + ["w", "j", "r", "l"] and phon[-1] != "#":
                    prop_used = 1
                    prop_dur = int_dur * prop_used
                    ...
                    if prop_f_in_used_i <= 0.5:
                        ...
                        return 0
                elif prev_phon_str not in vowels + ["w", "j", "r", "l"] and prev_phon[-1] != "#":
                    prop_used = 0.7
                    prop_dur = int_dur * prop_used
                    used_s = round(segments.intervals[seg_index].minTime, 3)
                    used_e = used_s + prop_dur
                    ...
                    if prop_f_in_used_i <= 0.5:
                        ...
                        return 0
                elif next_phon_str not in vowels + ["w", "j", "r", "l"] and phon[-1] != "#":
                    prop_used = 0.7
                    prop_dur = int_dur * prop_used
