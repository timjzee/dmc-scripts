...
input_file_path = tens_path + "ECSD/ecsd_en_ndl_static.csv"
...
#    else:
    ...
    with codecs.open(tens_path + "ECSD/syntax_en" + core_num + ".csv", "w", "utf-8") as g:
...
def multiProcess():
    ...
    with codecs.open(tens_path + "ECSD/syntax_en_comb_ecsd.csv", "w", encoding="utf-8") as g:
        for core in range(num_cores):
            core_n = str(core + 1 + running_cores)
            with codecs.open(tens_path + "ECSD/syntax_en" + core_n + ".csv", "r", encoding="utf-8") as f:
