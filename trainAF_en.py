...
print("Loading data...")
train_data = pd.read_csv(tens_path + "Bootstrap_n_large_" + corpus + "_train_labs.csv", sep=",", header=None)
valid_data = pd.read_csv(tens_path + "Bootstrap_n_large_" + corpus + "_valid_labs.csv", sep=",", header=None)
...
classifier = train_nn_classification_model(
    ...
    hidden_units=[300],
    training_file=tens_path + "Bootstrap_n_large_" + corpus + "_train.csv",
    validation_file=tens_path + "Bootstrap_n_large_" + corpus + "_valid.csv")
