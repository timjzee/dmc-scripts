...
input_file_path = tens_path + "IFADVcorpus/ifadv_en_ndl_static_final.csv"
...
#    else:
    ...
    with codecs.open(tens_path + "IFADVcorpus/syntax_en" + core_num + ".csv", "w", "utf-8") as g:
...
def multiProcess():
    ...
    with codecs.open(tens_path + "IFADVcorpus/syntax_en_comb_ifadv.csv", "w", encoding="utf-8") as g:
        for core in range(num_cores):
            core_n = str(core + 1 + running_cores)
            with codecs.open(tens_path + "IFADVcorpus/syntax_en" + core_n + ".csv", "r", encoding="utf-8") as f:
