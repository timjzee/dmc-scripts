...
print("Loading data...")
train_data = pd.read_csv(tens_path + "Bootstrap_s_train_comp-o_labs.csv", sep=",", header=None)
valid_data = pd.read_csv(tens_path + "Bootstrap_s_valid_comp-o_labs.csv", sep=",", header=None)
...
def train_nn_classification_model(learning_rate, steps, batch_size, hidden_units, training_file, validation_file):
    ...
    classifier = tf.estimator.DNNClassifier(feature_columns=feature_columns, n_classes=n_classes[af], hidden_units=hidden_units, optimizer=my_optimizer, config=tf.contrib.learn.RunConfig(keep_checkpoint_max=1), model_dir=tens_path + af + "_model_comp-o")
    ...
    with open(tens_path + af + "_comp-o_validation_cm.csv", "w") as f:
...
classifier = train_nn_classification_model(
    ...
    training_file=tens_path + "Bootstrap_s_train_comp-o.csv",
    validation_file=tens_path + "Bootstrap_s_valid_comp-o.csv")
