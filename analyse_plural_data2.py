...
possible_verbs = [
    "aanval", "adder", "bank", "barbecue", "big", "bijdrage", "boete", "bloed", "bos", "brief", "club", "dam", "dokter", "eikel", "film", "flirt", "gal", "grieve", "groep", "grond", "gruwel", "hengel", "heuvel", "hint", "hoeve", "kajak", "kandelaar", "kap", "kar", "kenteken", "keten", "kik", "kit", "klem", "klik", "lade", "leg", "leraar", "lobby", "maal", "mat", "match", "mentor", "meubel", "moer", "monitor", "naaste", "nagel", "nevel", "orakel", "parel", "pass", "pier", "pik", "pop", "post", "ram", "rank", "regel", "rel", "ring", "room", "ruzie", "sar", "schaduw", "sim", "speech", "sponsor", "sprint", "stel", "steppe", "stop", "storm", "strip", "tafel", "tand", "teken", "test", "tip", "toer", "tong", "trip", "twist", "type", "vel", "vinger", "vuur", "wapen", "water", "week", "werk", "wortel", "zijn", "zon"
]
...
forbidden_words = [
    ...
    "voortgang", "gebed", "geluid", "gevecht", "gezicht", "afstand", "bedrijf", "bruid", "bruiloft", "naam", "oorlog", "publiek", "seizoen", "toegang", "god", "arend", "district", "faillissement", "gedachte", "gevaar", "havik", "kanon", "lende", "lichaam", "linde", "moer", "neutron", "ongeluk", "uitgang", "vakbond", "verstand", "vierkant", "wereld",

    # English forms more frequent than Dutch in Subtlex-NL
    "ring", "stern", "big", "client", "palm"
]
