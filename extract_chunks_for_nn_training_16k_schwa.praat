...
if macintosh
    ...
    frag_path$ = "/Volumes/tensusers/timzee/af_classification/training_chunks_n/" + component$ + "/"
else
    tens_path$ = "/vol/tensusers/timzee/" + corpus$ + "/"
    audio_path$ = "/vol" + a_path$
    ort_path$ = "/vol" + o_path$
    frag_path$ = "/vol/tensusers/timzee/af_classification/training_chunks_n/" + component$ + "/"
endif
...
Read Table from comma-separated file: tens_path$ + "cgn_index_o_final_nl.txt"
