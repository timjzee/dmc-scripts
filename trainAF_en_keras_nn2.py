...
with open(tens_path + "training_numbers_" + str(context_size) + ".json", "r") as f:
    tr_dicts = json.load(f)

train_rows = tr_dicts[0]   # 5c-16k: ???; 5c-8k: ???
valid_rows = tr_dicts[1]   # 5c-16k: ???; 5c-8k: ???
test_rows = tr_dicts[2]    # 5c-16k: ???; 5c-8k: ???
