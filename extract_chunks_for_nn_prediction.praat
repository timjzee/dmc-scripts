...
if macintosh
    ...
    frag_path$ = "/Volumes/tensusers/timzee/af_classification/pred_fragments/" + component$ + "/"
else
    tens_path$ = "/vol/tensusers/timzee/" + corpus$ + "/"
    audio_path$ = "/vol" + o_path$
    frag_path$ = "/vol/tensusers/timzee/af_classification/pred_fragments/" + component$ + "/"
endif
...
Read Table from comma-separated file: tens_path$ + "comp-c_s_ndl.csv"
