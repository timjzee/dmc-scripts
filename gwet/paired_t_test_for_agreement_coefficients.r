...
ttest.fleiss <- function(g1.ratings,g2.ratings,weights="unweighted",conflev=0.95,N=Inf){ 
  ...
  n1 <- nrow(g1.ratings)
  if (n2==n1){
    coeff2.i<-fleiss.linear.i(g2.ratings,weights,conflev,N)
    coeff1.i<-fleiss.linear.i(g1.ratings,weights,conflev,N)
...
#                      Educational and Psychological Measurement, Vol 76(4) 609-637.
#======================================================================================
ttest.ac2 <- function(g1.ratings,g2.ratings,weights="unweighted",conflev=0.95,N=Inf){ 
  n2 <- nrow(g2.ratings)
  n1 <- nrow(g1.ratings)
  if (n2==n1){
...
#                      Educational and Psychological Measurement, Vol 76(4) 609-637.
#======================================================================================
ttest.conger <- function(g1.ratings,g2.ratings,weights="unweighted",conflev=0.95,N=Inf){ 
  n2 <- nrow(g2.ratings)
  n1 <- nrow(g1.ratings)
  if (n2==n1){
...
conger.linear.i <- function(ratings,weights="unweighted",conflev=0.95,N=Inf){ 
  ...
  if (is.numeric(ratings.mat)){
    ...
    for(k in 1:q){
      ...
      pe.ivec2 <- pe.ivec2 + delta.ig.mat%*%(pgk.mat%*%bkl.mat[,k])
    }
  }
