...
gs_df$schwa_perc20_TR_TS_startb <- rep(0.1, num_gs)
gs_df$schwa_perc20_TR_NN_startb <- rep(0.1, num_gs)
gs_df$schwa_perc20_TR_TS_starte <- rep(0.1, num_gs)
gs_df$schwa_perc20_TR_NN_starte <- rep(0.1, num_gs)
gs_df$schwa_perc20_TR_TS_endb <- rep(0.1, num_gs)
gs_df$schwa_perc20_TR_NN_endb <- rep(0.1, num_gs)
gs_df$schwa_perc20_TR_TS_ende <- rep(0.1, num_gs)
gs_df$schwa_perc20_TR_NN_ende <- rep(0.1, num_gs)
gs_df$schwa_perc20_TR_TS <- rep(0.1, num_gs)
gs_df$schwa_perc20_TR_NN <- rep(0.1, num_gs)
gs_df$nasal_perc20_TR_TS_startb <- rep(0.1, num_gs)
gs_df$nasal_perc20_TR_NN_startb <- rep(0.1, num_gs)
gs_df$nasal_perc20_TR_TS_starte <- rep(0.1, num_gs)
gs_df$nasal_perc20_TR_NN_starte <- rep(0.1, num_gs)
gs_df$nasal_perc20_TR_TS_endb <- rep(0.1, num_gs)
gs_df$nasal_perc20_TR_NN_endb <- rep(0.1, num_gs)
gs_df$nasal_perc20_TR_TS_ende <- rep(0.1, num_gs)
gs_df$nasal_perc20_TR_NN_ende <- rep(0.1, num_gs)
gs_df$nasal_perc20_TR_TS <- rep(0.1, num_gs)
gs_df$nasal_perc20_TR_NN <- rep(0.1, num_gs)
gs_df$nasalization_perc20_TR_TS_b <- rep(0.1, num_gs)
gs_df$nasalization_perc20_TR_NN_b <- rep(0.1, num_gs)
gs_df$nasalization_perc20_TR_TS_e <- rep(0.1, num_gs)
gs_df$nasalization_perc20_TR_NN_e <- rep(0.1, num_gs)
gs_df$nasalization_perc20_TR_TS <- rep(0.1, num_gs)
gs_df$nasalization_perc20_TR_NN <- rep(0.1, num_gs)
gs_df$perc20_TR_TS <- rep(0.1, num_gs)
gs_df$perc20_TR_NN <- rep(0.1, num_gs)
gs_df$variant_accuracy <- rep(0.1, num_gs)
gs_df$variant_macro_Fscore <- rep(0.1, num_gs)
gs_df$variant_accuracy_TZ <- rep(0.1, num_gs)
gs_df$variant_macro_Fscore_TZ <- rep(0.1, num_gs)
...
gs_df[,(num_par+1):ncol(gs_df)] <- t(sapply(1:nrow(gs_df), getGsData))

gs_df <- gs_df[order(gs_df$perc20_TR_NN, decreasing = T),]
