...
#                            g.write("\t".join([i, word["pos"].split("_")[i_num], word["lemma"].split("_")[i_num], str(word["posprob"]), word["dep"], str(word["depindex"]), str(word["index"]), "1", word["chunker"].split("-")[-1]]) + "\n")
                    else:
                        g.write("\t".join([word["text"], word["pos"], word["lemma"], str(word["posprob"]), word["dep"], str(word["depindex"]), str(word["index"]), "0"]) + "\n")
#                        g.write("\t".join([word["text"], word["pos"], word["lemma"], str(word["posprob"]), word["dep"], str(word["depindex"]), str(word["index"]), "0", word["chunker"].split("-")[-1]]) + "\n")
