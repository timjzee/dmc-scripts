...
mistakes = {
    "S": [
        ...
        "zo",
        "extreem",
        "aankoop",   # woorden met prefix vaak afgebroken samenstelling?
        "gebed",
        "geluid",
        "gevecht",
        "gezicht",
...
possible_verbs = [
    ...
    "lade", "speech", "hint", "leg", "lobby", "pass", "pik", "ram", "stel", "stop", "storm", "toer", "tongen", "week", "vuur", "zon", "aanval", "barbecue", "kajak", "grieve"
]
...
#            pl_class = dataset_verb[wrd]['class']
    ...
    if os.path.exists(tens_path + "timbl_files/" + model_name + ".var"):
        os.remove(tens_path + "timbl_files/" + model_name + ".var")
...
#        loo_acc = "NA"
    ...
    if os.path.exists(tens_path + "timbl_files/" + model_name + ".var"):
        os.remove(tens_path + "timbl_files/" + model_name + ".var")
    if os.path.exists(tens_path + "timbl_files/" + model_name + ".test"):
        os.remove(tens_path + "timbl_files/" + model_name + ".test")
    if os.path.exists(tens_path + "timbl_files/" + model_name + ".master.out"):
        os.remove(tens_path + "timbl_files/" + model_name + ".master.out")
    if os.path.exists(tens_path + "timbl_files/" + model_name + ".master.train"):
        os.remove(tens_path + "timbl_files/" + model_name + ".master.train")
...
if grid_search:
    ...
    with codecs.open(tens_path + "timbl_files/grid_search.log", "w") as f:
