...
Append column: "kal_@_b"
Append column: "kal_@_e"
...
#                appendInfoLine: "Asserting '" + kal_word$ + "' == '" + w_ort$ + "'"
    ...
    for annotator_i from 1 to 2
        ...
        if fileReadable(annot_chunk_path$)
            ...
            schwa_reduction$ = Get value: annotateChunk.id, a$ + "_@_reduction"
    ...
    selectObject: "Table chunks"
    Set string value: annotateChunk.id, "kal_@_b", kal_schwa_b$
    Set string value: annotateChunk.id, "kal_@_e", kal_schwa_e$
...
selectObject: "Table chunks"
Save as comma-separated file: tensusers$ + "classifier_evaluation/en/nn_eval_en_o1_annotated.csv"
