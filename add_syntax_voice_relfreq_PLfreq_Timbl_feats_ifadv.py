...
#                print(line_l)
                ...
                g.write(",".join(line_l + syn_feats + [voice, lemma] + relfreq + [pl_s_freq, pl_en_freq, pl_propo, lemma_freq, relfreq_pl, timbl_s_prob]) + "\n")
...
def multiProcess():
    ...
    with codecs.open(tens_path + "IFADVcorpus/synvoirelPL_s_comb_ifadv_timbl.csv", "w", encoding="utf-8") as g:
        for core in range(num_cores):
            core_n = str(core + 1 + running_cores)
