...
print("Loading data...")
train_data = pd.read_csv(tens_path + "AF_train_labs.csv", sep=",", header=None)
valid_data = pd.read_csv(tens_path + "AF_valid_labs.csv", sep=",", header=None)
...
def create_training_input_fn(data_file, batch_size, num_epochs=5, shuffle=True):
    ...
    Returns:
      ...
      training.
    """
    def _input_fn(num_epochs=5, shuffle=True):
...
classifier = train_nn_classification_model(
    ...
    training_file=tens_path + "AF_train.csv",
    validation_file=tens_path + "AF_valid.csv")
